...
public class Network extends Model implements Serializable {
    ...
    public void printSummary() {
        System.out.format("StochLib.Network model: %s\n", this.getName());
        System.out.format("--------------------------------------------------------\n");
    ...
    public void saveCopy(String fname) {
        try {
            FileOutputStream fileOut =
                    new FileOutputStream("/home/matts/Masters/IndivProj/models/" + fname);
    ...
    public static Network loadCopy(String fname) {
        Network n = null;
        try {
            FileInputStream fileIn = new FileInputStream("/home/matts/Masters/IndivProj/models/" + fname);
